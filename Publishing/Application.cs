...
public static SpecialistBook CreateDefaultSpecialistBook(){
    ...
    public static void TestBooksService(){
        ...
        Console.WriteLine(booksService.CreateBook(new Isbn(), "fTitle1", 120, 29.99, true, empty).Info());
        Console.WriteLine(booksService.CreateBook(new Isbn(), "kTitle2", 130, 19.99, true, school).Info());
        Console.WriteLine(booksService.CreateBook(new Isbn(), "aTitle3", 110, 9.99, true, specialist).Info());
        Console.WriteLine(booksService.FindBookByIsbn(new Isbn()).Info());
